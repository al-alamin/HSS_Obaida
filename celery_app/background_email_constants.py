...
BODY_FEEDBACK = """
    ...
    helping other students in their venture.
    Please feel free to write to us at support@mystudynotebook.com or our Facebook group
    https://www.facebook.com/groups/mystudynotebook/. 
...
body_new_user = """
    ...
    to all the features of My Study Notebook. Below is your account information:
    Your Username : {0} 
...
SOP_RECEIVED = """
Hi {0}, 
We have received your document. We will send feedback as soon as we are done with reviewing. 
